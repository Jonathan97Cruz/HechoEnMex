...
<html lang="en">
    ...
    <body>
        ...
        <div class="container-fluid">
            ...
            <form action="addSeg.php" method="POST"> 
                <div class="row">
                    <div class="col-md-12">
                        <input name="idS" id="idS" type="hidden" value="<?php echo $id ?>" class="form-control">
                    </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <select name="carc" id="carc" class="form-select">
                                    <option value="Selecciona una opción">Selecciona una opción</option>
                                    <option value="Entregado">Entregado</option>
                                    <option value="En revisión">En revisión</option>
                                    <option value="Falta">Falta</option>
                            ...
                            <div class="col-sm-5">
                                <textarea name="carco" id="carco"  rows="1"  class="form-control" placeholder="Observaciones"></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <select name="camap" id="camap" class="form-select">
                                    <option value="Selecciona una opción">Selecciona una opción</option>
                                    <option value="Entregado">Entregado</option>
                                    <option value="En revisión">En revisión</option>
                                    <option value="Falta">Falta</option>
                            ...
                            <div class="col-sm-5">
                                <textarea name="camapo" id="camapo"  rows="1"  class="form-control" placeholder="Observaciones"></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <select name="propr" id="propr" class="form-select">
                                    <option value="Selecciona una opción">Selecciona una opción</option>
                                    <option value="Entregado">Entregado</option>
                                    <option value="En revisión">En revisión</option>
                                    <option value="Falta">Falta</option>
                            ...
                            <div class="col-sm-5">
                                <textarea name="propro" id="propro"  rows="1"  class="form-control" placeholder="Observaciones"></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <select name="pmarcp" id="pmarcp" class="form-select">
                                    <option value="Selecciona una opción">Selecciona una opción</option>
                                    <option value="Entregado">Entregado</option>
                                    <option value="En revisión">En revisión</option>
                                    <option value="Falta">Falta</option>
                            ...
                            <div class="col-sm-5">
                                <textarea name="pmarcpo" id="pmarcpp"  rows="1"  class="form-control" placeholder="Observaciones"></textarea>
                            </div>
                        </div>
                    </div>
                </div>
